...
const UserDashboard = () => {
  ...
  const dashboardItems = [
    { title: 'Shopping Cart', icon: ShoppingCart, content: '3 items', link: '/user/cart', color: 'bg-gradient-to-br from-pink-500 to-rose-600' },
    { title: 'Wishlist', icon: Heart, content: '12 items', link: '/user/wishlist', color: 'bg-gradient-to-br from-purple-500 to-violet-600' },
    { title: 'Wallet', icon: Wallet, content: 'Balance: ₹250.00', link: '/user/wallet', color: 'bg-gradient-to-br from-emerald-500 to-green-600' },
    { title: 'Address', icon: MapPin, content: '2 saved addresses', link: '/user/address', color: 'bg-gradient-to-br from-amber-500 to-yellow-600' },
    { title: 'Account Details', icon: User, content: 'John Doe', link: '/user/account', color: 'bg-gradient-to-br from-blue-500 to-indigo-600' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Welcome Card */}
          <div className="col-span-full p-6 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-xl">
            <div className="flex items-center justify-between">
          ...
          {dashboardItems.map((item, index) => (
            <div
              key={index}
              className={`group p-6 rounded-2xl ${item.color} shadow-xl transform transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl`}
            >
          ...
          {/* Track Order Card */}
          <div className="p-6 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 text-white shadow-xl">
          ...
          {/* Order History Card */}
          <div className="p-6 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 text-white shadow-xl">
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-white text-opacity-90 mb-4">View and manage your orders</p>
            <button 
