...
userRoute.get("/product/:id",getProductById)
// userRoute.get("/public/product/:id", getPublicProductById)
userRoute.get("/products",getAllProductsByUser)
userRoute.get("/allproducts",getAllProductsByUser)
userRoute.get("/categories",getAllCategories)
